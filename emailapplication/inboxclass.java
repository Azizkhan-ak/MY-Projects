...
public class inboxclass extends EmailApplication {
    private String user="";
    private String pass="";
    Session s;
 
    inboxclass(Session s,String user,String pass)
    {
       ...
       // inboxframe.setUndecorated(true);
        ...
        JButton closeinbox=new JButton("Close");
        closeinbox.setBounds(0, 0, 50, 40);
        closeinbox.setBackground(Color.red);
        //inboxframe.add(closeinbox);
...
System.out.println(msg.length);
  for (int i =msg.length-1; i>2410 ;i--) {
